...
3. Fill in the **BeCompliance Banner ID (Client ID)** field. In your Be.Aliant dashboard, open the banner and use the **Copy** button on the **"ID para configuração no GTM"** field — the value already comes in the `{company}/{banner}` format required here (e.g. `390/7cd8b688-58b1-4399-9410-705abd7b2025`). Pasting only the banner UUID produces an incomplete URL and the banner will not load.
...
* **Client ID (Required):** the value from the **"ID para configuração no GTM"** field in your Be.Aliant dashboard, already in the `{company}/{banner}` format. Example: `390/7cd8b688-58b1-4399-9410-705abd7b2025`.
